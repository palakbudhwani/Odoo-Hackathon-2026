      ...
      <div className="max-w-lg mx-auto">
        <div className="card bg-slate-950/80 border border-white/10 shadow-2xl backdrop-blur-xl">
          <div className="mb-6">
            ...
            <h2 className="text-3xl font-semibold text-white mt-3">Welcome back</h2>
          </div>
          <form onSubmit={submit} className="space-y-5">
            ...
            <button className="btn bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500" type="submit">Sign in</button>
          </form>
